    ...
    letters: [
      {
        ...
        roomId: 0,
        position: { x: "18%", y: "35%" },
        hint: "Starts the word meaning 'to rule or guide'"
      },
      {
        id: "o",
        letter: "O",
      ...
      },
      {
        ...
        roomId: 2,
        position: { x: "52%", y: "30%" },
        hint: "A letter shaped like a valley"
      },
      {
        id: "e",
        letter: "E",
        roomId: 3,
        position: { x: "68%", y: "60%" },
        hint: "Most common letter in English"
      },
      {
        id: "r",
        letter: "R",
    ...
    letters: [
      {
        ...
        roomId: 0,
        position: { x: "15%", y: "45%" },
        hint: "The first letter of 'deploy'"
      },
      {
        id: "e",
        letter: "E",
    ...
    letters: [
      {
        ...
        roomId: 0,
        position: { x: "20%", y: "30%" },
        hint: "The first letter of 'module'"
      },
      {
        id: "o",
        letter: "O",
      ...
      },
      {
        ...
        roomId: 3,
        position: { x: "72%", y: "55%" },
        hint: "A vowel shaped like a cup"
      },
      {
        id: "l",
        letter: "L",
    ...
    letters: [
      {
        ...
        roomId: 0,
        position: { x: "18%", y: "40%" },
        hint: "The first letter of 'access'"
      },
      {
        id: "c1",
        letter: "C",
    ...
    letters: [
      {
        ...
        roomId: 0,
        position: { x: "16%", y: "35%" },
        hint: "Starts the word meaning 'safe'"
      },
      {
        id: "e",
        letter: "E",
      ...
      },
      {
        ...
        roomId: 1,
        position: { x: "58%", y: "80%" },
        hint: "A repeated vowel at the end"
      }
    ]
  },
  "8": {
    ...
    letters: [
      {
        ...
        roomId: 0,
        position: { x: "18%", y: "45%" },
        hint: "The first letter of 'bridge'"
      },
      {
        id: "r",
        letter: "R",
      ...
      },
      {
        ...
        roomId: 1,
        position: { x: "60%", y: "78%" },
        hint: "A common vowel at the end"
      }
    ]
  },
  "9": {
    ...
    letters: [
      {
        ...
        roomId: 0,
        position: { x: "15%", y: "35%" },
        hint: "The first letter of 'future'"
      },
      {
        id: "u",
        letter: "U",
      ...
      },
      {
        ...
        roomId: 2,
        position: { x: "48%", y: "30%" },
        hint: "The 20th letter of the alphabet"
      },
      {
        id: "u2",
        letter: "U",
    ...
    letters: [
      {
        ...
        roomId: 0,
        position: { x: "18%", y: "40%" },
        hint: "The first letter of 'ecosystem'"
      },
      {
        id: "c",
        letter: "C",
      ...
      },
      {
        ...
        roomId: 3,
        position: { x: "66%", y: "32%" },
        hint: "Starts the sound in 'security'"
      },
      {
        id: "y",
        letter: "Y",
      ...
      },
      {
        ...
        roomId: 1,
        position: { x: "60%", y: "78%" },
        hint: "A repeated final consonant"
      }
    ]
  }
} as const;

export type ElectroquestRoom = typeof celoQuestRooms[keyof typeof celoQuestRooms];
